...
volatile uint16_t addres_wrzutnik = 2;
...
int main(void) {
	...
	_delay_ms(1000);
	// coin acceptor
	uartPut(addres_wrzutnik, 0, 1, 254, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 245, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 244, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 192, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 246, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 242, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 241, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 0, 1, 4, 0);
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {1});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {2});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {3});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {4});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {5});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {6});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {7});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 1, 1, 184, (uint8_t[]) {8});
	_delay_ms(100);
	uartPut(addres_wrzutnik, 2, 1, 231, (uint8_t[]) {255,255});
	_delay_ms(100);
	uartPut(40, 2, 1, 231, (uint8_t[]) {255,255});
	_delay_ms(100);
	uartPut(40, 8, 1, 231, (uint8_t[]) {255,255,255,255,255,255,255,255});
	_delay_ms(50);
	...
	while (1) {
//===========================
		uartPut(addres_wrzutnik, 0, 1, 229, 0);
		for (i = 0; i < 21; i++) {
			bufferC[i] = uart_getc();
			if (firstRunC == 1) {

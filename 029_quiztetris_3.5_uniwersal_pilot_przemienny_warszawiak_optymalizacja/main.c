...
void configurationInit() {
	...
	FL_protection = 0, displayTimeout = 1000, FL_CARD = 1, FL_start_rules = 1, FL_counter_in =
			...
			0, FLAGA_END_TIME = 0, TMP_FLAGA_END_TIME_HIGH = 0, TMP_FLAGA_END_TIME_LOW =
			0;
...
void endTime() {
	...
	if (FLAGA_END_TIME == 1) {
		TMP_FLAGA_END_TIME_HIGH++;
		if (TMP_FLAGA_END_TIME_HIGH > 20000) {
			PAYOUT_OUT_Z;
			TMP_FLAGA_END_TIME_HIGH = 0;
		}

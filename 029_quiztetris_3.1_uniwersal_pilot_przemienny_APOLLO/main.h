...
#define LIGHT_AUTOMAT_IN IN1_23_PC4
#define DDR_LIGHT_AUTOMAT_IN DDRC &= ~(1<<LIGHT_AUTOMAT_IN)
#define PIN_LIGHT_AUTOMAT_IN PINC & _BV(LIGHT_AUTOMAT_IN)
#define LIGHT_AUTOMAT_IN_VCC PORTC |= _BV(LIGHT_AUTOMAT_IN)
#define LIGHT_AUTOMAT_IN_GND PORTC &= ~_BV(LIGHT_AUTOMAT_IN)

#define AUTOSTART_IN IN2_24_PC5
#define DDR_AUTOSTART_IN DDRC &= ~(1<<AUTOSTART_IN)
#define PIN_AUTOSTART_IN PINC & _BV(AUTOSTART_IN)
#define AUTOSTART_IN_VCC PORTC |= _BV(AUTOSTART_IN)
#define AUTOSTART_IN_GND PORTC &= ~_BV(AUTOSTART_IN)
...
#define WBA12_OUT WBA12V_15_PD6
#define WBA12_OUT_DDR DDRD |= (1<<WBA12_OUT)
#define WBA12_OUT_LOW PORTD &= ~(1<<WBA12_OUT)
#define WBA12_OUT_HIGH PORTD |= (1<<WBA12_OUT)
#define WBA12_OUT_Z PORTD ^= (1<<WBA12_OUT)
...
#define TOUCH_SCREEN_OUT OUT1_19_PC0
#define TOUCH_SCREEN_OUT_DDR DDRC |= (1<<TOUCH_SCREEN_OUT)
#define TOUCH_SCREEN_OUT_LOW PORTC &= ~(1<<TOUCH_SCREEN_OUT)
#define TOUCH_SCREEN_OUT_HIGH PORTC |= (1<<TOUCH_SCREEN_OUT)
#define TOUCH_SCREEN_OUT_Z PORTC ^= (1<<TOUCH_SCREEN_OUT)

#define AUTOSTARTR_OUT OUT2_20_PC1
#define AUTOSTARTR_OUT_DDR DDRC |= (1<<AUTOSTARTR_OUT)
#define AUTOSTARTR_OUT_LOW PORTC &= ~(1<<AUTOSTARTR_OUT)
#define AUTOSTARTR_OUT_HIGH PORTC |= (1<<AUTOSTARTR_OUT)
#define AUTOSTARTR_OUT_Z PORTC ^= (1<<AUTOSTARTR_OUT)
...
#define POWER_ON_OUT OUT5_37_PA0
#define POWER_ON_OUT_DDR DDRA |= (1<<POWER_ON_OUT)
#define POWER_ON_OUT_LOW PORTA &= ~(1<<POWER_ON_OUT)
#define POWER_ON_OUT_HIGH PORTA |= (1<<POWER_ON_OUT)
#define POWER_ON_OUT_Z PORTA ^= (1<<POWER_ON_OUT)

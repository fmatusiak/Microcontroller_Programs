...
#define DDR_start_in DDRC &= ~(_BV(start_in))
#define PIN_start_in PINC & _BV(start_in)
#define start_in_VCC PORTC |= _BV(start_in)
#define start_in_GND PORTC &= ~_BV(start_in)
#define start_in PC0
...
#define DDR_Puls_Out DDRB |= _BV(Puls_Out)
#define PORT_Puls_Out_0 PORTB &= ~_BV(Puls_Out)
#define PORT_Puls_Out_1 PORTB |= _BV(Puls_Out)
#define Puls_Out PB2

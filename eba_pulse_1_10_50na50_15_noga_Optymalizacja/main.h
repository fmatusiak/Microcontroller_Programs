...
#define DDR_dwojka DDRD &= ~(_BV(dwojka))
#define PIN_dwojka PIND & _BV(dwojka)
#define dwojka_VCC PORTD |= _BV(dwojka)
#define dwojka_GND PORTD &= ~_BV(dwojka)
#define dwojka PD5//4
...
#define DDR_dwojka_wy DDRB |= _BV(dwojka_wy)
#define PORT_dwojka_wy_0 PORTB &= ~_BV(dwojka_wy)
#define PORT_dwojka_wy_1 PORTB |= _BV(dwojka_wy)
#define PORT_dwojka_wy_z PORTB ^= _BV(dwojka_wy)
#define dwojka_wy PB1

...
volatile uint16_t delayCounts, counterTimeout, displayTimeout,counterTimeout_counter,TMP_LICZNIK_CZASU;
volatile uint8_t FL_counter, FL_automatOn, FL_payout, FL_display_switch,
		...
		command, pause, receive, FL_start,TMP_LICZNIK_CZASU_mod;
volatile uint8_t tmp_tetris, tmp_quiz, FL_start_rules, FL_counter_in,
		FL_display, FL_pilotes, FLAGA_Send,FL_KREDYT,FL_SEND_KREDYT;

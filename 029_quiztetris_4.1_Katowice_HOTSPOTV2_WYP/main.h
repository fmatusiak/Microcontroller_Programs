...
volatile uint8_t commandBuffer[50],TMP_receive[15];
// ========================================== quiz command =============================================================================
...
volatile uint16_t delayCounts, counterTimeout, displayTimeout,counterTimeout_counter,loop_time;
...
volatile uint8_t tmp_tetris, tmp_quiz, FL_start_rules, FL_counter_in,
		FL_display, FL_pilotes, FLAGA_Send,FL_KREDYT,FL_SEND_KREDYT,loop_time_mod , FL_loop_time,FL_wyk;

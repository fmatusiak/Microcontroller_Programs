...
#define BUTTON_1_IN PC1//SW
#define DDR_BUTTON_1_IN DDRC &= ~(1<<BUTTON_1_IN)
#define PIN_BUTTON_1_IN PINC & _BV(BUTTON_1_IN)
#define BUTTON_1_IN_VCC PORTC |= _BV(BUTTON_1_IN)
#define BUTTON_1_IN_GND PORTC &= ~_BV(BUTTON_1_IN)

#define BUTTON_2_IN PC0//SW
#define DDR_BUTTON_2_IN DDRC &= ~(1<<BUTTON_2_IN)
#define PIN_BUTTON_2_IN PINC & _BV(BUTTON_2_IN)
#define BUTTON_2_IN_VCC PORTC |= _BV(BUTTON_2_IN)
#define BUTTON_21_IN_GND PORTC &= ~_BV(BUTTON_1_IN)
...
#define KEY_SWITCH_ADMIN_IN PB4//I2C
#define DDR_KEY_SWITCH_ADMIN_IN DDRB &= ~(1<<KEY_SWITCH_ADMIN_IN)
#define PIN_KEY_SWITCH_ADMIN_IN PINB & _BV(KEY_SWITCH_ADMIN_IN)
#define KEY_SWITCH_ADMIN_IN_VCC PORTB |= _BV(KEY_SWITCH_ADMIN_IN)
#define KEY_SWITCH_ADMIN_IN_GND PORTB &= ~_BV(KEY_SWITCH_ADMIN_IN)

#define KEY_SWITCH_SERWIS_IN PB5//I2C
#define DDR_KEY_SWITCH_SERWIS_IN DDRB &= ~(1<<KEY_SWITCH_SERWIS_IN)
#define PIN_KEY_SWITCH_SERWIS_IN PINB & _BV(KEY_SWITCH_SERWIS_IN)
#define KEY_SWITCH_SERWIS_IN_VCC PORTB |= _BV(KEY_SWITCH_SERWIS_IN)
#define KEY_SWITCH_SERWIS_IN_GND PORTB &= ~_BV(KEY_SWITCH_SERWIS_IN)

// ========================================================================================================

#define RELAY_1_OUT PB0 //Hopper 2
#define RELAY_1_OUT_DDR DDRB |= (1<<RELAY_1_OUT)
#define RELAY_1_OUT_LOW PORTB &= ~(1<<RELAY_1_OUT)
#define RELAY_1_OUT_HIGH PORTB |= (1<<RELAY_1_OUT)
#define RELAY_1_OUT_Z PORTB ^= (1<<RELAY_1_OUT)

#define RELAY_2_OUT PB1 //Hopper 2
#define RELAY_2_OUT_DDR DDRB |= (1<<RELAY_2_OUT)
#define RELAY_2_OUT_LOW PORTB &= ~(1<<RELAY_2_OUT)
#define RELAY_2_OUT_HIGH PORTB |= (1<<RELAY_2_OUT)
#define RELAY_2_OUT_Z PORTB ^= (1<<RELAY_2_OUT)

#define RELAY_3_OUT PB2 //Hopper 2
#define RELAY_3_OUT_DDR DDRB |= (1<<RELAY_3_OUT)
#define RELAY_3_OUT_LOW PORTB &= ~(1<<RELAY_3_OUT)
#define RELAY_3_OUT_HIGH PORTB |= (1<<RELAY_3_OUT)
#define RELAY_3_OUT_Z PORTB ^= (1<<RELAY_3_OUT)
...
#define NV10ID_NUMBER_1 0//89
#define NV10ID_NUMBER_2 66//31
#define NV10ID_NUMBER_3 11//32

...
void configurationInit() {
	...
	FL_pilotes = 0, FLAGA_Send = 0,FL_Caffe = 0,FL_Nabij = 1,FL_Settings_automat = 1,FL_SA = 1,FL_Hopper_time = 0, FL_PILOT_E =1, FL_PILOT_F=1;
	...
	com_nabijKredyt = 9, com_money_twenty = 10 , com_money_fifty = 11, com_money_hundred = 12, com_pilot_e=13, com_pilot_f=14 ;
	...
	Tmp_time_payout = 0,Tmp_time_hopper_low = 5000,Tmp_time_hopper_high = 5000,time_hopper = 5000;

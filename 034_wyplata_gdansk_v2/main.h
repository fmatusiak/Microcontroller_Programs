...
#define DDR_KEY_3_OUT DDRC |= _BV(KEY_3_OUT)
#define PORT_KEY_3_OUT_1 PORTC &= ~_BV(KEY_3_OUT)
#define PORT_KEY_3_OUT_0 PORTC |= _BV(KEY_3_OUT)
#define PORT_KEY_3_OUT_z PORTC ^= _BV(KEY_3_OUT)
#define KEY_3_OUT PC3

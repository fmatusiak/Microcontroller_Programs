...
// ========================================== quiz command =============================================================================
volatile uint8_t com_counter_start, com_counter_stop, com_attack, com_clear_time_switch, com_switch_on_tetris, com_on_automat, com_switch_on, sended,com_quiz_start_rules, com_quiz_on;
// ========================================== tetris command ===========================================================================
...
volatile uint16_t toLong, startTimeout, startImpulseTime, counter_off ,switchTimeout;
volatile uint8_t TETRIS_ON, QUIZ_ON,JACKPOT_ON,PROT_ON, FL_TETRIS_ON , FL_QUIZ_ON, FL_pilot, FL_CARD;
volatile uint16_t delayCounts, counterTimeout, displayTimeout;
...
volatile uint8_t tmp_tetris, tmp_quiz,FL_start_rules,FL_counter_in, FL_display;

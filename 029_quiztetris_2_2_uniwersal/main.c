...
void configurationInit() {
	...
	sended = 1, com_counter_start = 11, com_counter_stop = 12, com_attack = 13, com_clear_time_switch =
			14, com_switch_on_tetris = 7, com_on_automat = 3, com_switch_on = 8,com_quiz_start_rules = 3,
	...
	FL_keySwitch = 1,FL_display = 0;
;
	tmp_tetris = 1, tmp_quiz = 1, startTimeout = 0, startImpulseTime = 4000;
	FL_protection = 0, displayTimeout = 1000, FL_CARD = 1,FL_start_rules = 1,FL_counter_in = 0;
...
void displaySwitch() {
	...
	if ((!(PIN_DISPLAY_CHANGE_BUTTON_IN)) && (switchTimeout > 1000) && (FL_display == 1))
	{
		SCREEN_SWITCH_OUT_HIGH;
		switchTimeout = 0;
	}

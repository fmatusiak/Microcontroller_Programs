...
void lcd_display(uint8_t data){
	...
	switch (data){
		...
		case 1:
			lcd_puts("Error: 0x01");
			lcd_gotoxy(0,1);
			lcd_puts("ACCEPTOR ERRROR");
			break;
		case 2:
			lcd_puts("Error: 0x02");
			lcd_gotoxy(0,1);
			lcd_puts("HOPPER ERROR");
			break;
		case 3:
			lcd_puts("Error: 0x03");
			lcd_gotoxy(0,1);
			lcd_puts("SERVICE SWITCH ERROR");
			break;
		case 4:
			lcd_puts("Error: 0x04");
			lcd_gotoxy(0,1);
			lcd_puts("BTN 1 ERROR");
			break;
		case 5:
			lcd_puts("Error: 0x05");
			lcd_gotoxy(0,1);
			lcd_puts("BTN 2 ERROR");
			break;
		case 6:
			lcd_puts("Error: 0x06");
			lcd_gotoxy(0,1);
			lcd_puts("HOPPER:COIN LVL LOW");
			break;
		case 7:
			lcd_puts("Error: 0x07");
			lcd_gotoxy(0,1);
			lcd_puts("HOPPER:COIN SENSOR");
			break;
		case 8:
			lcd_puts("Error: 0x08");
			lcd_gotoxy(0,1);
			lcd_puts("HOPPER:EMPTY SENSOR");
			break;
	}
}
/*

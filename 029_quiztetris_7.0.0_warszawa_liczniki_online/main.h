...
#define BUTTON_BUTTON_IN IN2_24_PC5
#define DDR_BUTTON_BUTTON_IN DDRC &= ~(1<<BUTTON_BUTTON_IN)
#define PIN_BUTTON_BUTTON_IN PINC & _BV(BUTTON_BUTTON_IN)
#define BUTTON_BUTTON_IN_VCC PORTC |= _BV(BUTTON_BUTTON_IN)
#define BUTTON_BUTTON_IN_GND PORTC &= ~_BV(BUTTON_BUTTON_IN)
...
#define HOLD_BUTTON_IN RX2_11_PD2
#define DDR_HOLD_BUTTON_IN DDRD &= ~(1<<HOLD_BUTTON_IN)
#define PIN_HOLD_BUTTON_IN PIND & _BV(HOLD_BUTTON_IN)
#define HOLD_BUTTON_IN_VCC PORTD |= _BV(HOLD_BUTTON_IN)
#define HOLD_BUTTON_IN_GND PORTD &= ~_BV(HOLD_BUTTON_IN)
...
#define COUNTER_OUT_IN IN5_40_PB0
#define DDR_COUNTER_OUT_IN DDRB &= ~(1<<COUNTER_OUT_IN)
#define PIN_COUNTER_OUT_IN PINB & _BV(COUNTER_OUT_IN)
#define COUNTER_OUT_IN_VCC PORTB |= _BV(COUNTER_OUT_IN)
#define COUNTER_OUT_IN_GND PORTB &= ~_BV(COUNTER_OUT_IN)
...
// OUTS
#define BUTTON_BUTTON_OUT OUT2_20_PC1
...
#define HOLD_BUTTON_OUT TX1_12_PD3
#define HOLD_BUTTON_OUT_DDR DDRD |= (1<<HOLD_BUTTON_OUT)
#define HOLD_BUTTON_OUT_LOW PORTD |= (1<<HOLD_BUTTON_OUT)
#define HOLD_BUTTON_OUT_HIGH PORTD &= ~(1<<HOLD_BUTTON_OUT)
#define HOLD_BUTTON_OUT_Z PORTD ^= (1<<HOLD_BUTTON_OUT)
...
volatile uint8_t klik_payout, key_switch_clear, com_add_time_one,
		...
		Counter_IN_25, Counter_OUT_1, Counter_OUT_2, Counter_OUT_5,
		Counter_OUT_10,Counter_OUT_25;
...
volatile uint16_t counter_pulses,counter_pulses_out;

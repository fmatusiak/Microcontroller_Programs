...
#define RX2_11_PD2 PD2 // conter_spin
...
// ================================== IN PROGRAM ================================
// INS
#define COUNTER_SPIN_IN	RX2_11_PD2
#define DDR_COUNTER_SPIN_IN DDRD &= ~(1<<COUNTER_SPIN_IN)
#define PIN_COUNTER_SPIN_IN PIND & _BV(COUNTER_SPIN_IN)
#define COUNTER_SPIN_IN_VCC PORTD |= _BV(COUNTER_SPIN_IN)
#define COUNTER_SPIN_IN_GND PORTD &= ~_BV(COUNTER_SPIN_IN)
...
volatile uint8_t send_hearts, sended, buffer_size, counter_pulses,
		...
		com_unlock_pay;
//==========================================JACKPOT command ============================================================
volatile uint8_t buzzer_on, buzzer_off, com_off_jackpot, com_on_jackpot;

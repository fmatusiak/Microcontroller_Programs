...
#define LED_BUTTON_IN RX2_11_PD2
#define DDR_LED_BUTTON_IN DDRD &= ~(1<<LED_BUTTON_IN)
#define PIN_LED_BUTTON_IN PIND & _BV(LED_BUTTON_IN)
#define LED_BUTTON_IN_VCC PORTD |= _BV(LED_BUTTON_IN)
#define LED_BUTTON_IN_GND PORTD &= ~_BV(LED_BUTTON_IN)
...
volatile uint8_t com_caffe_on,com_off_value,com_start_automat,com_disp,com_disp_caffe;

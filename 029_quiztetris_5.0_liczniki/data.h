...
#define COUNTER_IN_IN WE2_33_PA4
#define DDR_COUNTER_IN_IN DDRA &= ~(1<<COUNTER_IN_IN)
#define PIN_COUNTER_IN_IN PINA & _BV(COUNTER_IN_IN)
#define COUNTER_IN_IN_VCC PORTA |= _BV(COUNTER_IN_IN)
#define COUNTER_IN_IN_GND PORTA &= ~_BV(COUNTER_IN_IN)

#define COUNTER_OUT_IN BARMAN_35_PA2

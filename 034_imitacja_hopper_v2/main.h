...
#define DDR_PAYOUT_IN DDRD &= ~(_BV(KEY_SWITCH_IN)) // IN 3
#define PIN_PAYOUT_IN  PIND & _BV(KEY_SWITCH_IN)
#define PAYOUT_IN_VCC PORTD |= _BV(KEY_SWITCH_IN)
#define PAYOUT_IN_GND PORTD &= ~_BV(KEY_SWITCH_IN)
#define PAYOUT_IN  PD7

...
#define PILOT_KEY_IN RX2_11_PD2
#define DDR_PILOT_KEY_IN DDRD &= ~(1<<PILOT_KEY_IN)
#define PIN_PILOT_KEY_IN PIND & _BV(PILOT_KEY_IN)
#define PILOT_KEY_IN_VCC PORTD |= _BV(PILOT_KEY_IN)
#define PILOT_KEY_IN_GND PORTD &= ~_BV(PILOT_KEY_IN)
...
// ========================================== quiz command =============================================================================
volatile uint8_t com_counter_start, com_counter_stop, com_attack, com_clear_time_switch, com_switch_on_tetris, com_on_automat, com_switch_on, sended;
// ========================================== tetris command ===========================================================================
volatile uint8_t send_hearts, sended, buffer_size, counter_pulses,  com_send_tetris, com_send_hearts, com_round, com_lock_pay, com_unlock_pay;
volatile uint16_t toLong, startTimeout, startImpulseTime, counter_off ;
volatile uint8_t TETRIS_ON, QUIZ_ON,JACKPOT_ON,PROT_ON, FL_TETRIS_ON , FL_QUIZ_ON, FL_pilot;
volatile uint16_t delayCounts, counterTimeout;
volatile uint8_t FL_counter, FL_automatOn, FL_payout, FL_display_switch, FL_settingsQuiz, FL_settingsTetris,FL_keySwitch, FL_protection, command, pause, receive;
volatile uint8_t tmp_tetris, tmp_quiz;
///Pilot
volatile uint16_t pilot_date;
volatile uint8_t FL_kom_pilot, iter_kom;
volatile uint16_t iterGND, iterVCC;

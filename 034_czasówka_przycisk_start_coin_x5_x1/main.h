...
#define DDR_LIGHT_OUT DDRD |= _BV(LIGHT_OUT)
#define PORT_LIGHT_OUT_0 PORTD &= ~_BV(LIGHT_OUT)
#define PORT_LIGHT_OUT_1 PORTD |= _BV(LIGHT_OUT)
#define PORT_LIGHT_OUT_z PORTD ^= _BV(LIGHT_OUT)  // IN 5
#define LIGHT_OUT PD1 //TX2

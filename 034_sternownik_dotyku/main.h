...
#define DDR_LED_ONE_OUT DDRD |= _BV(LED_ONE_OUT)
#define PORT_LED_ONE_OUT_0 PORTD &= ~_BV(LED_ONE_OUT)
#define PORT_LED_ONE_OUT_1 PORTD |= _BV(LED_ONE_OUT)
#define PORT_LED_ONE_OUT_z PORTD ^= _BV(LED_ONE_OUT)
#define LED_ONE_OUT PD7

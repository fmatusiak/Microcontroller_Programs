...
#define dwojka_wy PC4 // okok

#define DDR_trojka_wy DDRC |= _BV(trojka_wy)
#define PORT_trojka_wy_0 PORTC &= ~_BV(trojka_wy)
#define PORT_trojka_wy_1 PORTC |= _BV(trojka_wy)
#define PORT_trojka_wy_z PORTC ^= _BV(trojka_wy)
#define trojka_wy PC5 //okok

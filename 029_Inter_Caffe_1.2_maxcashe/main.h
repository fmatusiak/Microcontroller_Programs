...
#define WYPLATA_IN RX2_11_PD2
#define DDR_WYPLATA_IN DDRD &= ~(1<<WYPLATA_IN)
#define PIN_WYPLATA_IN PIND & _BV(WYPLATA_IN)
#define WYPLATA_IN_VCC PORTD |= _BV(WYPLATA_IN)
#define WYPLATA_IN_GND PORTD &= ~_BV(WYPLATA_IN)
...
#define LIGHT_START_IN WE2_33_PA4
#define DDR_LIGHT_START_IN DDRA &= ~(1<<LIGHT_START_IN)
#define PIN_LIGHT_START_IN PINA & _BV(LIGHT_START_IN)
#define LIGHT_START_IN_VCC PORTA |= _BV(LIGHT_START_IN)
#define LIGHT_START_IN_GND PORTA &= ~_BV(LIGHT_START_IN)
...
volatile uint8_t com_caffe_is,com_payout,com_payout_button,com_money_one,com_money_two,com_money_five,com_money_ten,com_key_switch,com_nabijKredyt, com_money_twenty, com_money_fifty,com_money_hundred;

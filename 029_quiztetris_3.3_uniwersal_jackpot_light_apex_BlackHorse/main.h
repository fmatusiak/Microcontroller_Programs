...
// ================================== IN PROGRAM ================================
// INS
#define JACKPOT_START_IN RX1_09_PD0
#define DDR_JACKPOT_START_IN DDRD &= ~(1<<JACKPOT_START_IN)
#define PIN_JACKPOT_START_IN PIND & _BV(JACKPOT_START_IN)
#define JACKPOT_START_IN_VCC PORTD |= _BV(JACKPOT_START_IN)
#define JACKPOT_START_IN_GND PORTD &= ~_BV(JACKPOT_START_IN)

#define JACKPOT_STAWKA_LIGHT_IN	RX2_11_PD2
#define DDR_JACKPOT_STAWKA_LIGHT_IN DDRD &= ~(1<<JACKPOT_STAWKA_LIGHT_IN)
#define PIN_JACKPOT_STAWKA_LIGHT_IN PIND & _BV(JACKPOT_STAWKA_LIGHT_IN)
#define JACKPOT_STAWKA_LIGHT_IN_VCC PORTD |= _BV(JACKPOT_STAWKA_LIGHT_IN)
#define JACKPOT_STAWKA_LIGHT_IN_GND PORTD &= ~_BV(JACKPOT_STAWKA_LIGHT_IN)
...
#define JACKPOT_START_LIGHT_IN IN1_23_PC4
#define DDR_JACKPOT_START_LIGHT_IN DDRC &= ~(1<<JACKPOT_START_LIGHT_IN)
#define PIN_JACKPOT_START_LIGHT_IN PINC & _BV(JACKPOT_START_LIGHT_IN)
#define JACKPOT_START_LIGHT_IN_VCC PORTC |= _BV(JACKPOT_START_LIGHT_IN)
#define JACKPOT_START_LIGHT_IN_GND PORTC &= ~_BV(JACKPOT_START_LIGHT_IN)
...
#define WBA_SWITCH WBA_PRZE_13_PD4
#define WBA_SWITCH_DDR DDRD |= (1<<WBA_SWITCH)
#define WBA_SWITCH_LOW PORTD &= ~(1<<WBA_SWITCH)
#define WBA_SWITCH_HIGH PORTD |= (1<<WBA_SWITCH)
#define WBA_SWITCH_Z PORTD ^= (1<<WBA_SWITCH)
...
volatile uint8_t send_hearts, sended, buffer_size, counter_pulses,
		...
		com_unlock_pay;
//==========================================JACKPOT command ============================================================
volatile uint8_t buzzer_on, buzzer_off, com_off_jackpot, com_on_jackpot,com_off_automat;

...
// ================================== IN PROGRAM ================================
// INS
#define JACKPOT_COUNTER_IN RX1_09_PD0
#define DDR_JACKPOT_COUNTER_IN DDRD &= ~(1<<JACKPOT_COUNTER_IN)
#define PIN_JACKPOT_COUNTER_IN PIND & _BV(JACKPOT_COUNTER_IN)
#define JACKPOT_COUNTER_IN_VCC PORTD |= _BV(JACKPOT_COUNTER_IN)
#define JACKPOT_COUNTER_IN_GND PORTD &= ~_BV(JACKPOT_COUNTER_IN)

...
#define KEY_1_IN IN5_40_PB0
#define DDR_KEY_1_IN DDRB &= ~(1<<KEY_1_IN)
#define PIN_KEY_1_IN PINB & _BV(KEY_1_IN)
#define KEY_1_IN_VCC PORTB |= _BV(KEY_1_IN)
#define KEY_1_IN_GND PORTB &= ~_BV(KEY_1_IN)

#define KEY_0_IN RX1_09_PD0
#define DDR_KEY_0_IN DDRD &= ~(1<<KEY_0_IN)
...
volatile uint16_t displayTimeout , counterTimeout,
		counterTimeout_counter, counterTimeout_counter_OUT;
...
volatile uint8_t Counter_IN_1_send, Counter_IN_5_send, Counter_IN_20_send,
		Counter_IN_50_send, Counter_IN_10_send, Counter_IN_100_send,
		Counter_OUT_100_send, Counter_OUT_25_send, Counter_OUT_10_send,
		Counter_OUT_5_send, Counter_OUT_1_send,Counter_OUT_50_send;

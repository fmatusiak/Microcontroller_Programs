...
// ================================== IN PROGRAM ================================
// INS
#define JACKPOT_LIGHT_ONE_IN RX1_09_PD0
#define DDR_JACKPOT_LIGHT_ONE_IN DDRD &= ~(1<<JACKPOT_LIGHT_ONE_IN)
#define PIN_JACKPOT_LIGHT_ONE_IN PIND & _BV(JACKPOT_LIGHT_ONE_IN)
#define JACKPOT_LIGHT_ONE_IN_VCC PORTD |= _BV(JACKPOT_LIGHT_ONE_IN)
#define JACKPOT_LIGHT_ONE_IN_GND PORTD &= ~_BV(JACKPOT_LIGHT_ONE_IN)

#define JACKPOT_LIGHT_TWO_IN	RX2_11_PD2
#define DDR_JACKPOT_LIGHT_TWO_IN DDRD &= ~(1<<JACKPOT_LIGHT_TWO_IN)
#define PIN_JACKPOT_LIGHT_TWO_IN PIND & _BV(JACKPOT_LIGHT_TWO_IN)
#define JACKPOT_LIGHT_TWO_IN_VCC PORTD |= _BV(JACKPOT_LIGHT_TWO_IN)
#define JACKPOT_LIGHT_TWO_IN_GND PORTD &= ~_BV(JACKPOT_LIGHT_TWO_IN)
...
#define JACKPOT_LIGHT_THREE_IN IN1_23_PC4
#define DDR_JACKPOT_LIGHT_THREE_IN DDRC &= ~(1<<JACKPOT_LIGHT_THREE_IN)
#define PIN_JACKPOT_LIGHT_THREE_IN PINC & _BV(JACKPOT_LIGHT_THREE_IN)
#define JACKPOT_LIGHT_THREE_IN_VCC PORTC |= _BV(JACKPOT_LIGHT_THREE_IN)
#define JACKPOT_LIGHT_THREE_IN_GND PORTC &= ~_BV(JACKPOT_LIGHT_THREE_IN)

...
#define POWER_OUT OUT5_37_PA0
#define POWER_OUT_DDR DDRA |= (1<<POWER_OUT)
#define POWER_OUT_LOW PORTA &= ~(1<<POWER_OUT)
#define POWER_OUT_HIGH PORTA |= (1<<POWER_OUT)
#define POWER_OUT_Z PORTA ^= (1<<POWER_OUT)
...
volatile uint8_t com_counter_start, com_counter_stop, com_attack,
		...
		com_switch_on, sended, com_quiz_start_rules, com_quiz_on,FLAGA_END_TIME;
// ========================================== tetris command ===========================================================================
...
volatile uint16_t delayCounts, counterTimeout, displayTimeout,counterTimeout_counter,TMP_FLAGA_END_TIME_HIGH,TMP_FLAGA_END_TIME_LOW;
volatile uint8_t FL_counter, FL_automatOn, FL_payout, FL_display_switch,
		...
		command, pause, receive, FL_start,tetris_run;

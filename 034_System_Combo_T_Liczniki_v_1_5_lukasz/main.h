...
#define COUNTER_IN_OUT PD6 //Hopper 2
#define COUNTER_IN_OUT_DDR DDRD |= (1<<COUNTER_IN_OUT)
#define COUNTER_IN_OUT_HIGH PORTD &= ~(1<<COUNTER_IN_OUT)
#define COUNTER_IN_OUT_LOW PORTD |= (1<<COUNTER_IN_OUT)
#define COUNTER_IN_OUT_Z PORTD ^= (1<<COUNTER_IN_OUT)

#define COUNTER_OUT_OUT PB0 //Hopper 2
#define COUNTER_OUT_OUT_DDR DDRB |= (1<<COUNTER_OUT_OUT)
#define COUNTER_OUT_OUT_HIGH PORTB &= ~(1<<COUNTER_OUT_OUT)
#define COUNTER_OUT_OUT_LOW PORTB |= (1<<COUNTER_OUT_OUT)
#define COUNTER_OUT_OUT_Z PORTB ^= (1<<COUNTER_OUT_OUT)
...
//system dealy
void _delay_ms_counter(uint16_t ms);
...
volatile uint16_t Money_In_Automat,Last_Transaction_Atmega,Last_Money_In,Money_IN_Liczniki,Money_OUT_Liczniki;
...
volatile uint16_t licznik_error;
volatile uint8_t time_door;
...
#define NV10ID_NUMBER_2 68//31/66
#define NV10ID_NUMBER_3 97//32/11
#define NV10ID_NUMBER_4 160//0

#define X6D2SID_NUMBER_1 12//101
#define X6D2SID_NUMBER_2 65//187
#define X6D2SID_NUMBER_3 41//28

#define HOPPER5ID_NUMBER_1 187
#define HOPPER5ID_NUMBER_2 99
#define HOPPER5ID_NUMBER_3 31

#define HOPPER1ID_NUMBER_1 186
#define HOPPER1ID_NUMBER_2 99
#define HOPPER1ID_NUMBER_3 31

#define HOPPER50ID_NUMBER_1 181
#define HOPPER50ID_NUMBER_2 99
#define HOPPER50ID_NUMBER_3 31

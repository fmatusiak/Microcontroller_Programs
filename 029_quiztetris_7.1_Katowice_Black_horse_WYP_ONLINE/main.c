...
void configurationInit() {
	...
	com_send_hearts = 11, counter_pulses = 0, counter_off = 10000, counter_off1 =
			60000;
	switchTimeout = 0;
	TETRIS_ON = 0, QUIZ_ON = 0, PROT_ON = 0, FL_TETRIS_ON = 1, FL_QUIZ_ON = 0;
	...
	FL_protection = 0, displayTimeout = 1000, FL_CARD = 1, FL_start_rules = 1, FL_counter_in =
			0, counterTimeout_counter = 0, FLAGA_Send = 0, FL_wyk = 0;
	counterTimeout_counter_OUT = 0, counter_pulses_out = 0;
	FL_KREDYT = 0;
	FL_SEND_KREDYT = 1;
	loop_time = 0;
	FL_loop_time = 0;
	...
	Counter_IN_1_send = 1;
	Counter_IN_5_send = 2;
	Counter_IN_10_send = 20;
	Counter_IN_20_send = 4;
	Counter_IN_50_send = 5;
	Counter_IN_100_send = 9;

	Counter_OUT_1_send = 10;
	Counter_OUT_5_send = 12;
	Counter_OUT_10_send = 15;
	Counter_OUT_25_send = 16;
	Counter_OUT_50_send = 19;
	Counter_OUT_100_send = 21;

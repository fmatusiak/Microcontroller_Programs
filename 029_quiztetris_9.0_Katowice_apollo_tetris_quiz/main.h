...
volatile uint8_t com_attack, com_quiz_start_rules, sended, com_switch_on_tetris,
		com_quiz_on, com_clear_time_switch,com_send_hearts;

// ========================================== tetris command ===========================================================================
volatile uint8_t com_lock_pay, com_unlock_pay, com_round;
volatile uint16_t counter_pulses;

volatile uint16_t counter_off,switchTimeout;

volatile uint8_t FL_QUIZ_ON, QUIZ_ON, TETRIS_ON,
		buffer_size,heart,FL_heart;

volatile uint16_t displayTimeout, counterTimeout;

volatile uint8_t receive, command, FL_automatOn, FL_start, pause, FL_payout,
		FL_counter, FL_protection, FL_keySwitch, FL_counter_pulses;

volatile uint8_t FL_counter_in, FL_start_rules, FL_wyk,
		FLAGA_Send, FL_KREDYT, FL_SEND_KREDYT, FL_display,FL_start_rules_counter;

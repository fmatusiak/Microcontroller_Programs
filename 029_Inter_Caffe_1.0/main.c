...
void configurationInit() {
	...
	FL_pilotes = 0, FLAGA_Send = 0,FL_Caffe = 0,FL_Nabij = 1,FL_Settings_automat = 1,FL_SA = 1;
	...
	FL_keySwitch = 0,FL_PAYOUT = 0,FL_START_PAYOUT = 0,FL_HOPPER = 0,money_pulses = 0 ,FL_Hopper_DOWN = 0,FL_Hopper_UP = 0;
	Tmp_time_payout = 0,Tmp_time_hopper_low = 0,Tmp_time_hopper_high = 0,time_hopper = 1000;

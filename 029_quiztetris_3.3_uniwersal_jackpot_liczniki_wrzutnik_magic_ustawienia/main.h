...
#define START_IN RX1_09_PD0
#define DDR_START_IN DDRD &= ~(1<<START_IN)
#define PIN_START_IN PIND & _BV(START_IN)
#define START_IN_VCC PORTD |= _BV(START_IN)
#define START_IN_GND PORTD &= ~_BV(START_IN)

#define JACKPOT_COUNTER_IN RX2_11_PD2
